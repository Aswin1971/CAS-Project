...
WebElement seeAll;
	...
	public boolean headersTooltipComparep1() throws IOException{
		...
		for(int i=0;i<list_tooltip.size();i++){				//Compare the Headers with toolTips
	...
	public void clickSeeAll(){
		...
		mywait.until(ExpectedConditions.elementToBeClickable(seeAll));   //wait till clickaSble of 'See All'
		seeAll.click();
	}
